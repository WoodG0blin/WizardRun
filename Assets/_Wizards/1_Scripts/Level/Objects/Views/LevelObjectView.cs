...
{
    internal class LevelObjectViewLegacy : MonoBehaviour, ILevelObjectView
    {
    ...
    internal class LevelObjectView : MonoBehaviour, ILevelObjectView
    {
        ...
        public void Draw(Vector3 position)
        {
            ...
            _initialScale = visualBody.localScale;
            SetActive(true);
        }
        public void SetActive(bool active) => gameObject.SetActive(active);
    ...
    internal class ViewMover
    {
        ...
        {
            _rigidbody = levelObject.GetComponent<Rigidbody>();
        }

        internal void Move(Vector2 direction) { }
    }

    internal class ViewJumper
    {
        protected Transform levelObject;
        internal ViewJumper(Transform levelObject) => this.levelObject = levelObject;
