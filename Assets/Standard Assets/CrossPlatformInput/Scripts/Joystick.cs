	...
	public class Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		void CreateVirtualAxes()
		{
			...
			if (m_UseX)
			{
				...
				//m_HorizontalVirtualAxis = CrossPlatformInputManager.AxisExists(horizontalAxisName) ? CrossPlatformInputManager.VirtualAxisReference(horizontalAxisName) : new CrossPlatformInputManager.VirtualAxis(horizontalAxisName);
				//CrossPlatformInputManager.RegisterVirtualAxis(m_HorizontalVirtualAxis);
			}
			if (m_UseY)
			{
